 ...
 *
 * This is the ONE sign-in gate for the whole platform (launchpad + every
 * workspace behind it) - deliberately HARTS-only branding, never a specific
 * customer's name or logo, since this page is shown before any workspace
 * has been chosen.
 */
      ...
      <div className="w-full max-w-sm rounded-card bg-cream border border-sand-200 shadow-hero p-8 flex flex-col items-center gap-5 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-ink-500">
            Sign in with your work account to continue to HARTS.
          </p>
        </div>
        ...
        <Suspense
          fallback={
            <div
              className="w-full rounded-lg text-white py-2.5 text-sm font-medium opacity-60"
